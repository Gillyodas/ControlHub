...
| User 1 | `EMP00001` | EmployeeID (2) | `Admin@123` | User |
| User 2 | `+84123456789` | Phone (1) | `Admin@123` | User |

### 🧪 Tài khoản mở rộng (Extended Test Accounts)

| **Loại** | **Identifier** | **Type** | **Password** | **Role** |
|---------|----------------|----------|-------------|----------|
| User | `testuser` | Username (2) | `Admin@123` | User |
| User | `test@example.com` | Email (0) | `Admin@123` | User |
